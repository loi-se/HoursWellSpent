...
namespace System.Windows.Forms.Calendar
{
        ...
        : ScrollableControl
    {
        ...
        public void CreateItemOnSelection(string itemText, bool editMode)
        {
            ...
            // ----------------Verandering KIJK UIT!! Veel gebruikt stukje code.
            // Onthou ingedrukte key om zo te voorkomen dat alle waardes van een agenda item automatisch gekopieerd worden
            item.Tag = itemText;
            //------------------------------
        ...
        protected override void OnDoubleClick(EventArgs e)
        {
            ...
            CreateItemOnSelection("doubleclick", true);
        }
        ...
        protected override void OnKeyDown(KeyEventArgs e)
        {
            ...
            {
                if (AllowNew)
                    CreateItemOnSelection("insert", true);
            }
        ...
        protected override void OnKeyPress(KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)13)
            {
                ...
                if (AllowNew)
                    CreateItemOnSelection("enter", true);
            }
        }
